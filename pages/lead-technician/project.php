...
$completionReportByProject = [
    'PRJ-1002' => [
        'date' => 'Apr 10, 2026',
        'description' => 'Final diagnostics and replacement work were completed successfully. Unit cooling performance returned to normal range and all final checks passed.',
        'photos' => ['imageSample.png'],
    ],
    'PRJ-1003' => [
        'date' => 'Apr 25, 2026',
        'description' => 'Ducting installation was completed and all target zones were balanced. Final airflow readings were documented and accepted during handover.',
                            ...
                            <div class="row g-2">
                                <?php foreach (($projectCompletionReport['photos'] ?? []) as $photo): ?>
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <img src="<?php echo htmlspecialchars((($baseUrl !== '' ? $baseUrl : '') . '/assets/img/' . $photo), ENT_QUOTES, 'UTF-8'); ?>" alt="Completion report photo" class="img-fluid rounded border report-photo">
                                    </div>
                                <?php endforeach; ?>
                            </div>
                        <?php else: ?>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function renderReportCards(reportList) {
        ...
        return '<div class="row g-3">' + reportList.map(function (report) {
            ...
            return '<div class="col-12">'
                ...
                + '<div class="mb-2">'
                + '<div class="small text-muted">Description</div>'
                + '<div class="small text-muted">' + escapeHtml(report.summary) + '</div>'
                + '</div>'
    ...
    if (saveTaskBtn) {
        saveTaskBtn.addEventListener('click', function () {
            ...
            if (!title || !assignee || !startDate || !dueDate) {
                return;
            }
