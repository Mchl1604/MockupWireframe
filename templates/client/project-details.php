...
<div class="row g-4">
    ...
    <div class="col-lg-6">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white fw-semibold">Quotation Summary</div>
            <div class="card-body">
                <div class="d-flex justify-content-between py-2 border-bottom small">
                ...
                <div class="d-flex justify-content-between pt-2 small fw-bold">
                    <span>Total</span>
