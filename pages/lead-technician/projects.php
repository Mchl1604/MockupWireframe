...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function buildProjectRow(project, showStatus) {
        ...
        return '<tr>'
            ...
            + (canMarkCompleted
                ? '<button type="button" class="btn btn-sm btn-success ms-2 mark-completed-btn" data-project-id="' + escapeHtml(project.id) + '" data-bs-toggle="modal" data-bs-target="#completionReportModal">Complete</button>'
                : '')
            + '</td>'
            + '</tr>';
    }
