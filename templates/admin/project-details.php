...
<a href="<?= h(url('/admin/projects')) ?>" class="btn btn-outline-secondary btn-sm mb-4">
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between py-2 border-bottom small">
                    ...
                    <span><?= h($project['quotationId']) ?></span>
                </div>
                <div class="d-flex justify-content-between py-2 border-bottom small">
                    <span class="text-muted">Materials</span>
                    <span><?= peso($project['quotation']['materials']) ?></span>
                </div>
                <div class="d-flex justify-content-between py-2 border-bottom small">
                    <span class="text-muted">Labor</span>
                    <span><?= peso($project['quotation']['labor']) ?></span>
                </div>
                <div class="d-flex justify-content-between pt-2 fw-bold small">
                    <span>Total</span>
                    <span><?= peso($project['quotation']['total']) ?></span>
                </div>
            </div>
        </div>
    </div>
...
<div class="card border-0 shadow-sm mt-4">
    <div class="card-header bg-white fw-semibold">Technician Reports</div>
    <div class="card-body">
        ...
        <div class="d-flex flex-column gap-3">
            ...
            <div class="border rounded p-3">
                <div class="d-flex align-items-center gap-2 mb-2">
                    ...
                    <span class="text-muted small"><?= h($rep['date']) ?> &mdash; <?= h($rep['projectLead']) ?></span>
                </div>
                <p class="small mb-2"><?= h($rep['description']) ?></p>
